...
public class PartnerRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public  PartnerRecyclerViewAdapter(Context context, List<String> list) {
        mContext = context;
        mList = list;
    }
    ...
    public void replaceData(List<String>  PartnerInfos) {
